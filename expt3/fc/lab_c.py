...
# This class extends the Lasagne DenseLayer to support partial training with some of the params fixed
class DenseLayer(lasagne.layers.DenseLayer):
	...
	def get_output_for(self, input, deterministic=False, **kwargs):
		...
		self.Ws = self.W *self.mask    ### those with 1 are to be learned.
		Wr = self.W
